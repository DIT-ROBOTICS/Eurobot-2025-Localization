...
class HealthCheckNode(Node):
    ...
    def read_button(self):
        ...
        start_lookup = { # x, y, z, x, y, z, w
            ...
            10:  (0.35, 1.60, 0.00, 0.00, 0.00, 0.707, -0.707),
            11:  (2.60, 0.90, 0.00, 0.00, 0.00, 1.00, 0.00),
            # 13:  (1.28, 0.30, 0.00, 0.00, 0.00, 0.707, 0.707),   # for Panda
            13:  (1.28, 0.40, 0.00, 0.00, 0.00, 1.00, 0.00),   # for Raccoon
            # team blue
            19:  (2.65, 1.70, 0.00, 0.00, 0.00, 0.707, -0.707),  
            15:  (0.40, 0.90, 0.00, 0.00, 0.00, 0.00, 1.00),     
            17:  (1.72, 0.40, 0.00, 0.00, 0.00, 1.00, 0.00),  
        }
